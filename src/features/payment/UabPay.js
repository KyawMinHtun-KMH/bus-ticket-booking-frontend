...
import image from "../images/uabpay.png";
...
const UabPay = ({ orderRequest, uabPayCloseHandler }) => {
      ...
      <div className="mt-2 text-start">
        <table className="table table-borderless table-sm summary-table">
          <tbody>
            <tr>
              <td>
                <p className="fw-bold d-inline">UabPay Number</p> &nbsp; : &nbsp;
                09787748496
              </td>
            </tr>
            <tr>
              <td>
                <p className="fw-bold d-inline">UabPay Name</p> &nbsp; : &nbsp;
                Khant Zin Min
              </td>
            </tr>
            <tr>
