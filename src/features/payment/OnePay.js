...
import image from "../images/onepay.png";
...
const OnePay = ({ orderRequest, onePayCloseHandler }) => {
      ...
      <div className="mt-2 text-start">
        <table className="table table-borderless table-sm summary-table">
          <tbody>
            <tr>
              <td>
                <p className="fw-bold d-inline">OnePay Number</p> &nbsp; : &nbsp;
                09787748496
              </td>
            </tr>
            <tr>
              <td>
                <p className="fw-bold d-inline">OnePay Name</p> &nbsp; : &nbsp;
                Khant Zin Min
              </td>
            </tr>
            <tr>
